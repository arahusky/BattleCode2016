...
public class RobotPlayer {
	...
	public static void runArchon(RobotController rc) {
	...
	public static void runScout(RobotController rc) {
		runDefault(rc);
	}
	...
	public static void runGuard(RobotController rc) {
		runDefault(rc);
	}

	public static void runViper(RobotController rc) {
		runDefault(rc);
	}

	public static void runTurret(RobotController rc) {
	...
	/**
	 * Default behavior of the robot.
	 */
	public static void runDefault(RobotController rc) {
